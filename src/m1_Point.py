...
class Point(object):
    ...
    def __init__(self,x,y):
        ...
        self.distance_movedx = 0
        self.distance_movedy = 0
        self.distance_movedz = 0
    ...
    def move_to(self,x,y):
        ...
        self.distance_movedx += (x - self.previousx)
        self.distance_movedy += (y - self.previousy)
    ...
    def move_by(self,x,y):
        ...
        if (x!=0) and (y!=0):
            distance_x = (self.x - self.previousx)
            distance_y = (self.y - self.previousy)

            self.distance_movedz = (math.sqrt(distance_x ** 2 + distance_y ** 2))
        else:
            self.distance_movedx += (self.x - self.previousx)
            self.distance_movedy += (self.y - self.previousy)
    ...
    def get_distance_from(self,Point):
        ...
        distance_z = math.sqrt(distance_x ** 2 + distance_y ** 2)
        return distance_z
    ...
    def get_distance_traveled(self):
        return self.distance_movedx + self.distance_movedy + self.distance_movedz
    ...
    def closer_to(self,p2,p3):
        ...
        if (self.x - p2.x == 0):
            ...
            return p3
        elif (self.x - p2.x) > (self.x - p3.x):
            return p3
        elif (self.x - p2.x) < (self.x - p3.x):
            return p2

    def halfway_to(self,p2):
        halfway_x = (self.x + p2.x)/2
        halfway_y = (self.y + p2.y)/2
